export const ThisQuestions = [
  {
    ...
    dataPertanyaan: [
      ...
      {
        id: 2,
        pertanyaan: "Dimana teks Proklamasi Kemerdekaan Indonesia dibacakan?",
        pilihan: [
          "Gedung Sate",
          "Istana Merdeka",
      ...
      {
        id: 3,
        pertanyaan: "Siapa penulis naskah Proklamasi Kemerdekaan Indonesia?",
        pilihan: [
          "Sutan Sjahrir",
          "Mohammad Yamin",
          "Ahmad Subardjo",
      ...
      },
      {
        id: 4,
        pertanyaan:
          "Apa nama organisasi yang didirikan oleh Soekarno pada tahun 1927?",
        pilihan: [
          "Budi Utomo",
